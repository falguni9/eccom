...
const routes = (app) => {
    ...
    app.get('/ecomm/api/v1/products', ProductController.getProducts);
      ...
      /* to get all products by a Id */
      app.get('/ecomm/api/v1/product/:productId', ProductController.getAllProductsByproductId);
  
      /* to get all products in the cost range and name*/
